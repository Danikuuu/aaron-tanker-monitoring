...
<div class="bg-white rounded-lg shadow p-6" x-data="{ showModal: false }">
    ...
    <div class="flex items-center justify-between mb-6">
        ...
        <button @click="showModal = true"
                class="inline-flex items-center gap-2 bg-[#FF5757] hover:bg-[#ff4040] text-white px-5 py-2 rounded-lg text-sm font-medium transition">
            ...
            <form method="POST" action="{{ route('admin.staff.create') }}" class="px-6 py-5 space-y-4">
                    ...
                    <div class="flex rounded-lg border border-gray-300 overflow-hidden text-sm">
                        <label class="flex-1 text-center">
                            ...
                            <span class="block py-2 cursor-pointer transition
                                         peer-checked:bg-[#FF5757] peer-checked:text-white
                ...
                <div class="grid grid-cols-2 gap-3">
                    <div>
                        ...
                        <input type="text" name="first_name" value="{{ old('first_name') }}"
                               placeholder="Juan"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#FF5757] @error('first_name') border-red-400 @enderror">
                        @error('first_name')
                    ...
                    <div>
                        ...
                        <input type="text" name="last_name" value="{{ old('last_name') }}"
                               ...
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#FF5757] @error('last_name') border-red-400 @enderror">
                        @error('last_name')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div>
                    ...
                    <input type="email" name="email" value="{{ old('email') }}"
                           ...
                           class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#FF5757] @error('email') border-red-400 @enderror">
                    @error('email')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input type="password" name="password"
                           ...
                           class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#FF5757] @error('password') border-red-400 @enderror">
                    @error('password')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="flex gap-3 pt-2">
                    ...
                    <button type="submit"
                            class="flex-1 bg-[#FF5757] hover:bg-[#ff4040] text-white px-4 py-2 rounded-lg text-sm font-medium transition">
                        Create User
                    </button>
                </div>
            </form>
