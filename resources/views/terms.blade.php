...
<div class="min-h-screen" style="background-image: url('/images/gas-station-bg.jpg'); background-size: cover; background-position: center;">
    <div class="min-h-screen bg-black/50 backdrop-blur-sm">
        <!-- Header -->
        <header class="bg-primary rounded-full mx-8 mt-8 px-8 py-4">
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-3">
                    <div class="w-12 h-12 bg-black rounded-full flex items-center justify-center">
                        <div class="text-primary text-xl font-bold">A</div>
                    </div>
                </div>
            ...
            <div class="bg-white rounded-lg shadow-2xl p-8 w-full max-w-2xl">
                ...
                <form method="POST" action="{{ route('staff.tanker-departure.store') }}" class="space-y-4">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            <label class="block text-sm font-medium mb-2">
                                Departure Date<span class="text-primary">*</span>
                            </label>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            <label class="block text-sm font-medium mb-2">
                                Select Fuel type<span class="text-primary">*</span>
                            </label>
                        ...
                        <div>
                            <label class="block text-sm font-medium mb-2">
                                Litters Deliver<span class="text-primary">*</span>
                            </label>
                    ...
                    <button type="submit" class="w-full bg-primary text-white py-3 rounded-full hover:bg-[#ff4040] transition font-semibold text-lg mt-6">
                        Submit
                    </button>
                </form>
            </div>
