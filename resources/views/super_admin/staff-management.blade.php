                ...
                <div x-data="{ showPassword: false }">
                    ...
                    <div class="relative">
                        <input :type="showPassword ? 'text' : 'password'" name="password"
                               ...
                               class="w-full px-3 py-2 pr-10 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary @error('password') border-red-400 @enderror">
                        <button type="button"
                ...
                <div x-data="{ showConfirmPassword: false }">
                    ...
                    <div class="relative">
                        <input :type="showConfirmPassword ? 'text' : 'password'" name="password_confirmation"
                               ...
                               class="w-full px-3 py-2 pr-10 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary">
                        <button type="button"
