    ...
    <div class="flex min-h-screen">
        ...
        <aside class="w-[350px] bg-[#FF5757] text-white fixed h-screen flex flex-col justify-between">
            ...
            <nav class="px-4">
                ...
                <a href="{{ route('admin.fuel-summary') }}" class="flex items-center gap-3 px-6 py-4 rounded-lg hover:bg-white hover:text-[#FF5757] transition {{ request()->routeIs('admin.fuel-summary') ? 'bg-white text-black' : '' }}">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('admin.password.request') }}" class="flex items-center gap-3 px-6 py-4 rounded-lg hover:bg-white hover:text-[#FF5757] transition {{ request()->routeIs('admin.password-reset') ? 'bg-white text-black' : '' }}">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
